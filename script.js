...
<span class="c-keyword">int</span> <span class="c-function">main</span>() {
    ...
    exercises: [
      ...
      {
        type: "choice",
        question: "Qual a forma correta de declarar uma constante inteira em C?",
        options: ["constant int x = 10;", "int x = 10;", "const int x = 10;", "#define x 10"],
        answer: "const int x = 10;",
        feedback: "A palavra-chave 'const' é usada antes do tipo para declarar uma variável cujo valor não pode ser alterado.",
      },
      {
        type: "code",
        question: "Declare uma variável do tipo char chamada 'inicial' e atribua a ela o valor 'J'.",
        keywords: ["char", "inicial", "=", "'J'", ";"],
        feedback: "A sintaxe é: char inicial = 'J';",
      },
      {
        type: "choice",
        question: "Qual especificador de formato é usado para imprimir um número inteiro (int)?",
        options: ["%f", "%c", "%d", "%s"],
        answer: "%d",
      ...
      },
      {
        ...
        answer: "int",
        feedback: "A função main deve retornar um número inteiro (geralmente 0 para sucesso).",
      },
      {
        type: "code",
        question: "Declare uma variável inteira chamada 'idade' e atribua o valor 18.",
        keywords: ["int", "idade", "=", "18", ";"],
        feedback: "Sintaxe: int idade = 18;",
      },
      {
        type: "choice",
        question: "Qual sequência de caracteres representa uma quebra de linha em C?",
        options: ["\\t", "\\n", "\\r", "\\b"],
        answer: "\\n",
      ...
      {
        type: "fill",
        question: "Complete o código para incluir a biblioteca padrão de entrada e saída.",
        codeSnippet: `#include <___>`,
        answer: "stdio.h",
        feedback: "stdio.h (Standard Input/Output) contém funções como printf e scanf.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      {
        type: "fill",
        question: "Complete a condição para verificar se 'a' E 'b' são maiores que zero.",
      ...
      {
        type: "code",
        question: "Escreva uma estrutura if-else if-else para verificar se um número 'n' é positivo, negativo ou zero.",
        keywords: ["if", "else if", "else", "n > 0", "n < 0"],
        feedback: "A estrutura seria: if (n > 0) { ... } else if (n < 0) { ... } else { ... }",
      },
      {
        type: "fill",
        question: "Complete o operador ternário para atribuir 1 se 'a' for maior que 'b', senão 0.",
        codeSnippet: `int maior = (a > b) ___ 1 : 0;`,
        answer: "?",
        feedback: "O operador ternário usa '?' para a condição e ':' para separar os valores.",
      },
      {
        type: "choice",
        question: "Qual palavra-chave define o caso padrão em um switch, executado se nenhum case corresponder?",
        options: ["default", "else", "break", "standard"],
        answer: "default",
        feedback: "O bloco 'default' é executado quando nenhuma das opções 'case' é verdadeira.",
      },
      {
        type: "code",
        question: "Escreva um if para verificar se um número 'n' é par (resto da divisão por 2 é 0).",
        keywords: ["if", "n", "%", "2", "==", "0"],
        feedback: "Use o operador módulo: if (n % 2 == 0) { ... }",
      },
      {
        type: "fill",
        question: "Complete a condição para verificar se 'a' OU 'b' são iguais a zero.",
        codeSnippet: `if (a == 0 ___ b == 0)`,
        answer: "||",
      ...
      {
        type: "code",
        question: "Escreva um código que verifica se 'idade' é maior que 18. Se sim, imprima 'Adulto'.",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        answer: "2",
        feedback: "Lembre-se que os índices começam em 0, então o terceiro elemento está no índice 2.",
      },
      {
        type: "code",
        question: "Declare e inicialize uma string (vetor de char) chamada 'cidade' com o valor \"Rio\".",
        keywords: ["char", "cidade", "[]", "=", "\"Rio\"", ";"],
        feedback: "A sintaxe é: char cidade[] = \"Rio\";",
      },
      {
        type: "code",
        question: "Use um laço 'for' para imprimir todos os 3 elementos do vetor 'notas'.",
        keywords: ["for", "i", "notas", "printf"],
        feedback: "A estrutura do laço for é for(int i=0; i<3; i++) { printf(\"%d\", notas[i]); }"
      },
      {
        type: "choice",
        question: "Qual a finalidade da instrução 'break' dentro de um laço?",
        options: ["Pular para a próxima iteração", "Terminar o programa", "Sair imediatamente do laço", "Retornar um valor"],
        answer: "Sair imediatamente do laço",
        feedback: "O 'break' interrompe a execução do laço (for, while, do-while) e continua a execução do programa após o laço."
      },
      {
        type: "fill",
        question: "Complete o laço 'do-while' para que ele imprima 'Teste' uma vez.",
        codeSnippet: `int i = 10; do { printf("Teste"); } while(i < ___);`,
        answer: "10",
        feedback: "O laço do-while executa o bloco e DEPOIS verifica a condição. Como i (10) não é menor que 10, o laço para após a primeira execução."
      },
      {
        type: "code",
        question: "Declare uma matriz de inteiros 2x3 (2 linhas, 3 colunas) chamada 'matriz'.",
        keywords: ["int", "matriz", "[2]", "[3]", ";"],
        feedback: "A sintaxe para uma matriz 2D é: int matriz[2][3];"
      },
      {
        type: "choice",
        question: "Qual função da biblioteca <string.h> é usada para obter o comprimento de uma string?",
        options: ["length()", "sizeof()", "strlen()", "strlength()"],
        answer: "strlen()",
        feedback: "A função strlen() (string length) retorna o número de caracteres em uma string, sem contar o caractere nulo final '\\0'."
      },
    ],
  },
  {
...
<span class="c-keyword">int</span> *ptr = &x;</pre>
    ...
    exercises: [
      ...
      {
        type: "choice",
        question: "Se 'p_aluno' é um ponteiro para uma struct, como acessamos o campo 'nota'?",
        options: ["p_aluno.nota", "*p_aluno.nota", "p_aluno->nota", "p_aluno&nota"],
        answer: "p_aluno->nota",
        feedback: "O operador '->' (seta) é usado para acessar membros de uma struct através de um ponteiro para ela.",
      },
      {
        type: "fill",
        question: "Complete o código para atribuir o endereço da variável 'valor' ao ponteiro 'ptr'.",
      ...
      {
        type: "code",
        question: "Defina uma struct chamada 'Ponto' com dois inteiros: 'x' e 'y'.",
        keywords: ["struct", "Ponto", "int", "x", "y", ";"],
        feedback: "struct Ponto { int x; int y; };",
      },
      {
        type: "choice",
        question: "O que acontece se incrementarmos um ponteiro de inteiro (ptr++) em uma arquitetura comum?",
        options: ["Aumenta o valor apontado em 1", "Avança 4 bytes na memória", "O ponteiro vira NULL", "Erro de compilação"],
        answer: "Avança 4 bytes na memória",
        feedback: "Aritmética de ponteiros move o endereço baseada no tamanho do tipo de dado (int geralmente tem 4 bytes).",
      },
      {
        type: "fill",
        question: "Para garantir que um ponteiro não aponta para lixo de memória, inicializamos com ___.",
        codeSnippet: `int *ptr = ___;`,
        answer: "NULL",
        feedback: "NULL é uma macro que representa um ponteiro nulo (endereço 0), indicando que ele não aponta para nada válido.",
      },
      {
        type: "code",
        question: "Crie um alias (apelido) 'Inteiro' para o tipo 'int' usando typedef.",
...
<span class="c-function">free</span>(v);</pre>
    ...
    exercises: [
      ...
      {
        type: "fill",
        question: "Complete o modo de abertura de arquivo para anexar dados ao final dele.",
        codeSnippet: `FILE *f = fopen("log.txt", "___");`,
        answer: "a",
        feedback: "O modo 'a' (append) abre o arquivo para escrita, posicionando o cursor no final. Se o arquivo não existir, ele é criado.",
      },
    ],
  },
  {
...
<span class="c-keyword">int</span> <span class="c-function">somar</span>(<span class="c-keyword">int</span> a, <span class="c-keyword">int</span> b) {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: ["O corpo da função", "A chamada da função", "A declaração da função antes do main", "O valor de retorno"],
        answer: "A declaração da função antes do main",
        feedback: "O protótipo (ou declaração) informa ao compilador sobre a existência da função antes de ela ser definida, evitando erros.",
      },
      {
        type: "code",
        question: "Crie uma função chamada 'dobro' que recebe um inteiro e retorna o dobro dele.",
        keywords: ["int", "dobro", "return", "*", "2"],
        feedback: "A função deve ter a assinatura 'int dobro(int numero)' e usar 'return numero * 2;' no corpo.",
      },
      {
        type: "fill",
        question: "Complete a chamada da função 'calcular' passando as variáveis 'a' e 'b'.",
        codeSnippet: `resultado = calcular(___, ___);`,
        answer: "a, b",
        feedback: "Os argumentos passados na chamada da função devem corresponder aos parâmetros da sua definição.",
      },
      {
        type: "choice",
        question: "O que são 'parâmetros' de uma função?",
        options: ["Variáveis globais", "O valor que a função retorna", "Variáveis locais que recebem os valores na chamada da função", "O nome da função"],
        answer: "Variáveis locais que recebem os valores na chamada da função",
        feedback: "Parâmetros são as 'entradas' que a função utiliza para realizar sua tarefa.",
      },
      {
        type: "code",
        question: "Escreva o protótipo de uma função chamada 'imprimir_msg' que não recebe parâmetros e não retorna valor.",
        keywords: ["void", "imprimir_msg", "(", ")", ";"],
        feedback: "A sintaxe do protótipo é: void imprimir_msg(void); ou void imprimir_msg();",
      },
      {
        type: "code",
        question: "Crie uma função 'soma_vetor' que recebe um vetor de inteiros e seu tamanho, e retorna a soma de seus elementos.",
        keywords: ["int", "soma_vetor", "int", "[]", "for", "return"],
        feedback: "A assinatura seria 'int soma_vetor(int vetor[], int tamanho)'. Dentro, um laço 'for' percorreria o vetor somando os valores.",
      },
    ],
  },
  {
...
*ptr = <span class="c-number">100</span>;         <span class="c-comment">// Altera valor para 100</span></pre>
    ...
    exercises: [
      {
        type: "choice",
        question: "Se `int *p = &x;`, qual expressão representa o valor de `x`?",
        options: ["&p", "*p", "p", "*x"],
        answer: "*p",
      ...
      {
        type: "fill",
        question: "Complete para declarar um ponteiro que aponta para um caractere.",
        codeSnippet: `___ *letra;`,
        answer: "char",
        feedback: "O tipo do ponteiro deve corresponder ao tipo da variável apontada.",
      },
      {
        type: "code",
        question: "Crie uma função 'reset' que recebe um ponteiro para inteiro e muda seu valor para 0.",
      ...
      },
      {
        ...
        options: ["O valor apontado", "O endereço de memória", "O tamanho do ponteiro", "Um erro"],
        answer: "O endereço de memória",
        feedback: "%p é o especificador de formato para imprimir endereços (ponteiros) em hexadecimal.",
      },
      {
        type: "fill",
        question: "Em um vetor `v`, `v` é equivalente ao endereço do ___ elemento.",
        codeSnippet: `&v[___]`,
        answer: "0",
        feedback: "O nome do vetor representa o endereço do primeiro elemento (índice 0).",
      },
      {
        type: "choice",
        question: "Se `ptr` é um ponteiro para um inteiro, o que `ptr++` faz?",
        options: ["Incrementa o valor do inteiro apontado", "Avança o ponteiro para o próximo endereço de inteiro", "Causa um erro de compilação", "Nada"],
        answer: "Avança o ponteiro para o próximo endereço de inteiro",
        feedback: "A aritmética de ponteiros move o endereço pelo tamanho do tipo de dado. Para um int (geralmente 4 bytes), o endereço avança 4 bytes.",
      },
      {
        type: "code",
        question: "Crie uma função 'troca' que recebe dois ponteiros para inteiros e troca os valores entre eles.",
        keywords: ["void", "troca", "int", "*a", "*b", "temp"],
        feedback: "void troca(int *a, int *b) { int temp = *a; *a = *b; *b = temp; }",
      },
      {
        type: "fill",
        question: "Para acessar o campo 'idade' de uma struct através de um ponteiro 'p_pessoa', usamos o operador ___.",
        codeSnippet: `int idade_pessoa = p_pessoa___idade;`,
        answer: "->",
        feedback: "O operador '->' (seta) é um atalho para desreferenciar o ponteiro da struct e acessar um de seus membros, equivalente a (*p_pessoa).idade.",
      },
      {
        type: "choice",
        question: "Qual é a maneira segura de inicializar um ponteiro que ainda não aponta para um endereço válido?",
        options: ["int *ptr = 0;", "int *ptr = NULL;", "int *ptr;", "Nenhuma das anteriores"],
        answer: "int *ptr = NULL;",
        feedback: "Inicializar um ponteiro com NULL é a prática padrão para indicar que ele não aponta para uma localização de memória válida, evitando comportamento indefinido.",
      },
    ],
  },
  {
...
<span class="c-function">printf</span>(<span class="c-string">"Primeiro número: %d"</span>, numeros[<span class="c-number">0</span>]);</pre>
    ...
    exercises: [
      {
        type: "choice",
        question: "Em um vetor declarado como `int v[10];`, qual é o índice do último elemento acessível?",
        options: ["10", "9", "0", "11"],
        answer: "9",
        feedback: "Os índices de um vetor de tamanho N vão de 0 a N-1. Portanto, para um vetor de 10 elementos, os índices vão de 0 a 9.",
      },
      {
        type: "code",
      ...
      {
        type: "fill",
        question: "Para acessar o quinto elemento de um vetor 'arr', você usa o índice ___.",
        codeSnippet: `valor = arr[___];`,
        answer: "4",
        feedback: "Lembre-se que a contagem de índices começa em 0. O primeiro elemento é arr[0], o segundo é arr[1], e assim por diante. O quinto é arr[4].",
      },
      {
        type: "code",
        question: "Use um laço 'for' para preencher um vetor de inteiros 'dados' de 5 posições com o valor de seu próprio índice (dados[0]=0, dados[1]=1, etc).",
        keywords: ["for", "int", "i", "< 5", "dados", "[i]", "=", "i"],
        feedback: "for(int i=0; i<5; i++) { dados[i] = i; }",
      },
      {
        type: "choice",
        question: "O que acontece se você tentar acessar um elemento fora dos limites de um vetor (ex: `arr[10]` em um vetor de 10 elementos)?",
        options: ["O programa sempre trava com um erro.", "O compilador impede que o código seja gerado.", "Ocorre um comportamento indefinido, podendo ler lixo de memória ou corromper dados.", "O valor retornado é sempre 0 ou NULL."],
        answer: "Ocorre um comportamento indefinido, podendo ler lixo de memória ou corromper dados.",
        feedback: "C não verifica os limites do vetor em tempo de execução. Acessar fora dos limites é um erro grave que leva a comportamento indefinido (undefined behavior).",
      },
      {
        type: "fill",
        question: "Complete a linha para declarar e inicializar um vetor com os valores 10, 20 e 30.",
        codeSnippet: `int valores[] = {___};`,
        answer: "10, 20, 30",
        feedback: "Você pode inicializar um vetor na declaração usando chaves {} e separando os valores por vírgula.",
      },
      {
        type: "code",
        question: "Declare uma matriz (vetor 2D) de caracteres 3x3 chamada 'jogo_da_velha'.",
        keywords: ["char", "jogo_da_velha", "[3]", "[3]", ";"],
        feedback: "Para matrizes, você especifica o tamanho de cada dimensão: char jogo_da_velha[3][3];",
      },
      {
        type: "choice",
        question: "Qual a principal vantagem de usar vetores?",
        options: ["Armazenar tipos de dados diferentes juntos", "Acessar elementos por um nome, em vez de um índice", "Armazenar múltiplos valores do mesmo tipo de forma organizada e acessá-los eficientemente", "Mudar de tamanho dinamicamente com facilidade"],
        answer: "Armazenar múltiplos valores do mesmo tipo de forma organizada e acessá-los eficientemente",
        feedback: "Vetores são ideais para coleções de dados homogêneos (mesmo tipo) que podem ser acessados rapidamente por um índice.",
      },
      {
        type: "fill",
        question: "Para descobrir o tamanho total em bytes de um vetor 'arr', usamos o operador ___.",
        codeSnippet: `size_t tamanho = ___(arr);`,
        answer: "sizeof",
        feedback: "O operador sizeof retorna o tamanho em bytes do tipo ou variável passada.",
      },
      {
        type: "code",
        question: "Escreva um laço 'for' que imprime um vetor 'v' de 5 posições de trás para frente (índices 4 a 0).",
        keywords: ["for", "i", "4", ">=", "0", "i--", "printf"],
        feedback: "for(int i=4; i>=0; i--) { printf(\"%d\", v[i]); }",
      },
      {
        type: "choice",
        question: "Em C, strings são vetores de char terminados por qual caractere especial?",
        options: ["\\n", "\\0", "\\t", "EOF"],
        answer: "\\0",
        feedback: "O caractere nulo (\\0) indica o fim de uma string na memória.",
      },
      {
        type: "code",
        question: "Declare um vetor de inteiros 'nums' com 3 elementos e inicialize-o com zeros.",
...
window.checkAnswer = function (unitIdx, exIdx) {
  ...
  if (isCorrect) {
    ...
    if (exercise.incorrectAttempts >= 3 && !exercise.completed) {
      const container = document.getElementById(`show-answer-container-${exIdx}`);
      if (container) {
